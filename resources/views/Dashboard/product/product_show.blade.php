...
<div class="card shadow d-flex border  p-0 ">
  <div class="card-body text-dark">
    <div class="row">
      <div class="col-md-2">
       <a class="btn shadow border" href="{{url('admin/product')}}">
       <i class="fab fa-product-hunt text-success text-center fa-2x mt-2"></i></a>
      </div>
    <div class="col-md-8">
     <h4 class="text-center font-weight-bold mt-3 text_color">Update or Delete Product</h4>
    </div>
    <div class="col-md-1">
...
<table class="table align-items-center table-flush" id="dataTable">
   ...
   <tr>
    ...
    <td class="a col-1"><img src="{{asset('uploads/img/'.$image['rimage'])}}" width="100%"> </td>
    @endforeach
